/* AlParseTokenManager.java */
/* Generated By:JavaCC: Do not edit this line. AlParseTokenManager.java */

/** Token Manager. */
@SuppressWarnings("unused")public class AlParseTokenManager implements AlParseConstants {
...
static private void jjCheckNAddTwoStates(int state1, int state2)
{
   ...
   jjCheckNAdd(state2);
    ...
    /** Constructor. */
    public AlParseTokenManager(JavaCharStream stream){
  ...
  /** Constructor. */
  public AlParseTokenManager (JavaCharStream stream, int lexState){
    ReInit(stream);
    SwitchTo(lexState);
  }
